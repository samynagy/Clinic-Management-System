...
public class JFram extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(jTextField1.getText().equals("Patient") && "Patient".equals(selectedOption))
        { // search from database
        AfterLogin a=new AfterLogin();
        a.show();
        dispose();
        }
        else if(jTextField1.getText().equals("Doctor") && "Doctor".equals(selectedOption)) {
            // search from database
             DocReport d=new DocReport();
             d.show();
             dispose();
        }
        else
